...
<head>
    ...
    <title>Relación Hoja de Carga - Orden</title>
...
<body>
    ...
    <div class="body-hoja">
        <h1>Relación Hoja de Carga - Orden</h1>
        <br>
                ...
                <tbody>
                    @foreach ($query as $row)
                        <tr>
                            ...
                            <td><a href="{{ route('hoja_carga', ['hoja_carga_id' => $row->hoja_id]) }}" class="hoja-tabla-ver">Ver más</a></td>
                            <td><a href="{{ route('eliminar_log', ['hoja_carga_id' => $row->hoja_id]) }}" class="hoja-tabla-ver">Eliminar</a></td>
                            <td><a href="{{ route('entregar_pedido', ['hoja_carga_id' => $row->hoja_id]) }}" class="hoja-tabla-ver">Entregar</a></td>
                        </tr>
                    @endforeach
                </tbody>
            </table>
        ...
        <div class="informacion">
            <a href="{{ route('insertar_pedido_hca') }}"><input type="submit" value="Añadir Pedido" class="hoja-tabla-ver"></a>
        </div>
        <br>
    </div>
</body>
